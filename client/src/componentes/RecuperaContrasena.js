...
const RecuperaContrasena = () => {
  ...
  return (
    <>
      ...
      <FormularioRegistro>
        <FormularioRegistroSecciones>
          <TitutuloSecciones>Alumno Encontrado</TitutuloSecciones>
          Usuario
          <Input2 type="text" name="nombre" placeholder="Nombre(s): Ej: Jose" />
          ...
          />
          Contraseña
          <Input2 type="password" name="password" placeholder="Contraseña" />
          Repite contraseña
          <Input2
            type="password"
            name="repeatPassword"
